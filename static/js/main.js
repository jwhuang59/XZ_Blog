...
$(".nav-right a").click(function(){
  $(".nav-right .search").animate({right:"0px"})

})
$(".nav-right .search span").click(function(){
  $(".nav-right .search").animate({right:"-315px"})
...
$(window).scroll(function(){
  if($(window).scrollTop() > 120 && document.documentElement.scrollTop || document.body.scrollTop >= 120){
    $(".nav").css({"position":"fixed","top":"0px","z-index":"999",})


  }else{
    $(".nav").css({"position":"relative","z-index":"999",})
  }

  if($(window).scrollTop() > 300 && document.documentElement.scrollTop || document.body.scrollTop >= 300){
    $(".layui-fixbar .top").css({"display":"block",})
